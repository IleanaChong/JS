class Level3 extends Phaser.Scene {
  ...
  this.anims.create({
    ...
    repeat:-1
     ...
     this.physics.add.overlap(this.player, this.bro2, this.hitbro2, null, this);

     this.physics.add.overlap(this.player, this.bro3, this.hitbro3, null, this);
