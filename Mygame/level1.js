...
this.physics.add.overlap(this.player, this.fish2, this.hitfish2, null, this);

this.physics.add.overlap(this.player, this.fish3, this.hitfish3, null, this);
  ...
  hitfish2(player, item) {
    console.log("Hit fish2!!!");
    this.cameras.main.shake(200);
    item.disableBody(true, true); // remove fish
    return false;
  }

  hitfish3(player, item) {
    console.log("Hit fish3!!!");
    this.cameras.main.shake(200);
    item.disableBody(true, true); // remove fish
    return false;
  }
